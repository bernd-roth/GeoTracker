...
class CustomLocationListener: LocationListener {
    ...
    // minDistance=0 so GPS_PROVIDER never withholds updates on a stationary phone.
    // A non-zero filter combined with Doppler-velocity warm-up makes the recording
    // appear frozen for the first several seconds after start.
    private var minDistanceBetweenUpdates: Float = 0f
    ...
    private var minDistanceMeters: Int = 0
