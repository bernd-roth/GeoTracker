...
/**
 * A composable that displays heart rate data in relation to altitude.
 * X-axis: Altitude (m), Y-axis: Heart Rate (bpm)
 */
@Composable
fun HeartRateAltitudeChart(
    entries: List<Entry>,
    lineColor: Color,
    fillColor: Color,
    ...
    val chartEntries = remember(entries) {
        // Sort by altitude (X value) for a coherent chart
